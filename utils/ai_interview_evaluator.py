...
def evaluate_interview_notes(candidate_name, position, interviewer_notes):
    ...
    if not interviewer_notes:
        interviewer_notes = (
            "Candidate demonstrated good problem solving skills, clear communication, and "
            "strong Python knowledge. Minor concerns about system design scaling experience."
        )
    ...
    return {
        ...
        "executive_summary": (
            f"Candidate demonstrated strong core capabilities for the {position or 'Software Engineer'} "
            "role with solid communication and problem-solving aptitude."
        ),
        "key_strengths": [
