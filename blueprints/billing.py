...
def verify_payment():
    from blueprints.org import provision_tenant, send_payment_confirmation_email, _TENANT_DOMAIN_SUFFIX
    ...
    set_password_url = f"https://{subdomain}.{_TENANT_DOMAIN_SUFFIX}/admin_reset_password/{reset_token}"
