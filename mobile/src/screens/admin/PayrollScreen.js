...
const styles = StyleSheet.create({
  ...
  periodTitle: { fontSize: 15, fontWeight: "700", color: "#0F172A", marginLeft: 8 },
  ...
  periodInput: { backgroundColor: "#F8FAFC", borderWidth: 1, borderColor: "#E2E8F0", borderRadius: 10, padding: 8, fontSize: 14, fontWeight: "700", textAlign: "center" },
  ...
  processBtnText: { color: "#FFFFFF", fontWeight: "700", marginLeft: 4 },
  ...
  heroAmount: { fontSize: 32, fontWeight: "800", color: "#FFFFFF", marginTop: 4, marginBottom: 16 },
  ...
  gridValue: { fontSize: 14, fontWeight: "700", color: "#38BDF8", marginTop: 2 },
  ...
  netAmount: { fontSize: 14, fontWeight: "800", color: "#15803D" },
