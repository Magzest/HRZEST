...
// Dummy employees (fallback when API unavailable)
const DUMMY_EMPLOYEES = [
  {
    ...
    gender: "Male",
    role: "admin",
    month_summary: { present: 22, half: 1, absent: 1, leave: 2 },
  },
  {
    employee_id: "EMP002",
    name: "Sophia Brown",
    ...
    gender: "Female",
    role: "employee",
    month_summary: { present: 24, half: 0, absent: 1, leave: 1 },
  },
  {
    employee_id: "EMP003",
    name: "Michael Wilson",
    ...
    gender: "Male",
    role: "employee",
    month_summary: { present: 20, half: 2, absent: 1, leave: 3 },
  },
  {
    employee_id: "EMP004",
    name: "Emma Davis",
    ...
    gender: "Female",
    role: "admin",
    month_summary: { present: 25, half: 0, absent: 1, leave: 0 },
  },
  {
    employee_id: "EMP005",
    name: "David Lee",
    ...
    gender: "Male",
    role: "employee",
    month_summary: { present: 18, half: 3, absent: 2, leave: 3 },
  },
];
